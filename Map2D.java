...
public interface Map2D {
	...
	*this function checks if the map is cyclic.
	...
	/**
	 * simple implementation of the flood fill algorithm as presented in"https://en.wikipedia.org/wiki/Flood_fill";
	 * @param map for the map about to be filled.
	 * @param x for the x coordinate of the start point.
	 * @param y for the y coordinate of the start point.
	...
	/////// add your code below ///////
	boolean isNeighbors(Pixel2D p1, Pixel2D p2);
}
